...
public class King : Pieces
{
    public override List<Vector2Int> GetAvailableMoves(ref Pieces[,] board)
    {
        ...
        for (int i = 0; i < xMovement.Length; i++)
        {
            ...
            //Check if target position is on board and doesn't have an ally piece on it
        ...
        if (team == 0) //White king castling
        {
            ...
            //Queen side castling
            if (ChessBoard.whiteQueenCastle &&
                board[1, 0] == null &&
                board[2, 0] == null &&
                board[3, 0] == null)
            {
        ...
        else //Black king
        {
            ...
            //Queen side castling
            if (ChessBoard.blackQueenCastle &&
                board[1, 7] == null &&
                board[2, 7] == null &&
                board[3, 7] == null)
            {
